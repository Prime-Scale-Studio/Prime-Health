/**
 * lib/notifications.ts â€” Server-side only
 ...
 *   - Never throw â€” return { success, error }
...
// Clients (lazy init â€” only validate keys at call-time, not module load)
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          ...
          <tr>
            <td style="padding: 48px 40px 40px 40px; background-color: ${bgColor}; text-align: center; border-bottom: 1px solid #DCFCE7;">
              <div style="display: inline-flex; align-items: center; justify-content: center; width: 64px; height: 64px; background-color: #FFFFFF; border-radius: 50%; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.2); margin-bottom: 24px;">
                <span style="color: ${accentColor}; font-size: 32px; line-height: 64px;">âœ“</span>
              </div>
                ...
                <tr>
                  <td>
                    ...
                    <div style="margin-top: 16px;">
                      <span style="color: ${accentColor}; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.2em;">âœ“ HIPAA COMPLIANT</span>
                    </div>
                  </td>
                </tr>
              </table>
...
export async function sendConfirmationEmail(
  ...
  console.error('ðŸ“§ Sending appointment confirmation emails')
  console.error('Mode:', isDev ? 'DEV (test mode)' : 'PRODUCTION')
  console.error('Patient email â†’ ', patientEmail)
  console.error('Doctor email â†’ ', doctorEmail)
  ...
  try {
    ...
    console.error('âŒ Global email error:', error)
...
export async function sendWhatsAppNotification(
  ...
  try {
    ...
    const messageBody = [
      ...
      ``,
      clinic.address
        ? `ðŸ“ *Address:* ${clinic.address}${clinic.city ? `, ${clinic.city}` : ""}`
        : null,
      ``,
